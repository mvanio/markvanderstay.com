...
website:
  open-graph: true
  image: "https://markvanderstay.com/posts/identify-most-valuable-customers/predicting-customer-lifetime-value.jpg"
...
The next step is to load the transaction data which has been formatted to show a purchase date and customer ID in every row. At this point a transaction cost isn't necessary but I have yet to find a store owner who provided transaction data without values. The price column then is optional. However, when available this variable will allow prediction of future spending. I'll cover that here in this post.
...
::: callout-tip
I find it is often challenging to obtain accurate starting values. The defaults often work well enough in many scenarios.
:::
